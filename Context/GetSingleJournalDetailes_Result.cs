...
namespace SuitappRest.Context
{
    ...
    public partial class GetSingleJournalDetailes_Result
    {
        ...
        public Nullable<int> HSlNo1 { get; set; }
        public string HName1 { get; set; }
        public Nullable<int> GUnder1 { get; set; }
        public Nullable<int> UserId2 { get; set; }
        public Nullable<System.DateTime> UDate1 { get; set; }
        public string Type2 { get; set; }
        public Nullable<bool> OCash1 { get; set; }
        public string Place1 { get; set; }
        public Nullable<int> Isdeleted2 { get; set; }
        public string SuitApps_id1 { get; set; }
